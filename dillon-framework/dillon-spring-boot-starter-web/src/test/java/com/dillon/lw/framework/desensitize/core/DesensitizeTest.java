package com.dillon.lw.framework.desensitize.core;

import com.dillon.lw.framework.common.util.json.JsonUtils;
import com.dillon.lw.framework.desensitize.core.annotation.Address;
import com.dillon.lw.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.dillon.lw.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.dillon.lw.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("dillon");
        ...
        desensitizeDemo.setRegex("你好，我是dillon");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("dillon");
        ...
        assertEquals("dillon", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "dillon", replacer = "*")
