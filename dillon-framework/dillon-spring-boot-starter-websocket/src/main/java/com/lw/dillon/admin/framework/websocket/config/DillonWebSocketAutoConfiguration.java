package com.lw.dillon.admin.framework.websocket.config;

import com.lw.dillon.admin.framework.mq.redis.config.DillonRedisMQConsumerAutoConfiguration;
import com.lw.dillon.admin.framework.mq.redis.core.RedisMQTemplate;
import com.lw.dillon.admin.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.lw.dillon.admin.framework.websocket.core.listener.WebSocketMessageListener;
import com.lw.dillon.admin.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.lw.dillon.admin.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.lw.dillon.admin.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.lw.dillon.admin.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.lw.dillon.admin.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.lw.dillon.admin.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.lw.dillon.admin.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.lw.dillon.admin.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.lw.dillon.admin.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.lw.dillon.admin.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.lw.dillon.admin.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.lw.dillon.admin.framework.websocket.core.session.WebSocketSessionManager;
import com.lw.dillon.admin.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class DillonWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "redis", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "rocketmq", matchIfMissing = true)
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${dillon.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "rabbitmq", matchIfMissing = true)
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${dillon.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "kafka", matchIfMissing = true)
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${dillon.websocket.sender-kafka.topic}") String topic) {
