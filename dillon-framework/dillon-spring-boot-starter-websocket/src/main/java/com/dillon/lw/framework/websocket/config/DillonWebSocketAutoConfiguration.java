package com.dillon.lw.framework.websocket.config;

import com.dillon.lw.framework.mq.redis.config.DillonRedisMQConsumerAutoConfiguration;
import com.dillon.lw.framework.mq.redis.core.RedisMQTemplate;
import com.dillon.lw.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.dillon.lw.framework.websocket.core.listener.WebSocketMessageListener;
import com.dillon.lw.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.dillon.lw.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.dillon.lw.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.dillon.lw.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.dillon.lw.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.dillon.lw.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.dillon.lw.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.dillon.lw.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.dillon.lw.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.dillon.lw.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.dillon.lw.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.dillon.lw.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.dillon.lw.framework.websocket.core.session.WebSocketSessionManager;
import com.dillon.lw.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class DillonWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "rabbitmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "dillon.websocket", name = "sender-type", havingValue = "kafka")
