...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.dillon.lw";
    private static final String ARTIFACT_ID = "dillon";
    private static final String PACKAGE_NAME = "com.dillon.lw";
    private static final String TITLE = "Dillon管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.dillon.lw";
