...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.lw.dillon";
    private static final String ARTIFACT_ID = "dillon";
    private static final String PACKAGE_NAME = "com.lw.dillon.admin";
    private static final String TITLE = "Dillon-Pro管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.lw.dillon";
        String artifactIdNew = "dillon";
        String packageNameNew = "com.lw.dillon.admin";
        String titleNew = "Dillon-Pro管理系统";
