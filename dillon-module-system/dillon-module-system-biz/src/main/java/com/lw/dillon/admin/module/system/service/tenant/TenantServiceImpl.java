...
import com.lw.dillon.admin.framework.tenant.core.util.TenantUtils;
...
import com.lw.dillon.admin.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 dillon.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
