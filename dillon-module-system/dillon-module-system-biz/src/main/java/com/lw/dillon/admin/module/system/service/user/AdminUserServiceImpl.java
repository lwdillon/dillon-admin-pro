...
import com.lw.dillon.admin.framework.datapermission.core.util.DataPermissionUtils;
...
import static com.lw.dillon.admin.module.system.enums.LogRecordConstants.*;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:dillonyuanma}")
