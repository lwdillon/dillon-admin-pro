package com.lw.dillon.admin.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.lw.dillon.admin.framework.common.enums.CommonStatusEnum;
import com.lw.dillon.admin.framework.common.exception.ServiceException;
import com.lw.dillon.admin.framework.common.pojo.PageResult;
import com.lw.dillon.admin.framework.common.util.collection.ArrayUtils;
...
import com.lw.dillon.admin.module.infra.api.file.FileApi;
...
import com.lw.dillon.admin.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.lw.dillon.admin.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.lw.dillon.admin.module.system.controller.admin.user.vo.user.UserPageReqVO;
...
import com.lw.dillon.admin.module.system.dal.mysql.dept.UserPostMapper;
import com.lw.dillon.admin.module.system.dal.mysql.user.AdminUserMapper;
import com.lw.dillon.admin.module.system.enums.common.SexEnum;
...
import com.lw.dillon.admin.module.system.service.permission.PermissionService;
import com.lw.dillon.admin.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("dillonyuanma");
        ...
        assertEquals("dillonyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("dillonyuanma"))).thenReturn("java");
