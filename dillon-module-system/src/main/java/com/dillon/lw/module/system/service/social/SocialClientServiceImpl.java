package com.dillon.lw.module.system.service.social;
...
import com.dillon.lw.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.dillon.lw.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.dillon.lw.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.dillon.lw.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.dillon.lw.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.dillon.lw.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.dillon.lw.module.system.dal.dataobject.social.SocialClientDO;
import com.dillon.lw.module.system.dal.mysql.social.SocialClientMapper;
...
import com.dillon.lw.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.dillon.lw.framework.common.util.collection.MapUtils.findAndThen;
import static com.dillon.lw.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.dillon.lw.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.dillon.lw.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${dillon.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${dillon.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/dillon-cloud/pulls/230
