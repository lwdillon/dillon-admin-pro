package com.dillon.lw.module.system.service.user;
...
import com.dillon.lw.framework.test.core.ut.BaseDbUnitTest;
import com.dillon.lw.module.infra.api.config.ConfigApi;
import com.dillon.lw.module.infra.api.file.FileApi;
...
import com.dillon.lw.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.dillon.lw.module.system.controller.admin.user.vo.user.UserImportRespVO;
...
import com.dillon.lw.module.system.dal.mysql.dept.UserPostMapper;
...
import static com.dillon.lw.framework.common.util.collection.SetUtils.asSet;
import static com.dillon.lw.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.dillon.lw.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.dillon.lw.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.dillon.lw.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.dillon.lw.framework.test.core.util.AssertUtils.assertServiceException;
import static com.dillon.lw.framework.test.core.util.RandomUtils.*;
import static com.dillon.lw.module.system.enums.ErrorCodeConstants.*;
import static com.dillon.lw.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("dillonyuanma");
    }
