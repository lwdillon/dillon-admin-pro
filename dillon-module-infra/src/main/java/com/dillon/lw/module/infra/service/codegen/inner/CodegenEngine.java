package com.dillon.lw.module.infra.service.codegen.inner;
...
import com.dillon.lw.framework.common.util.date.LocalDateTimeUtils;
...
public class CodegenEngine {
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.dillon.lw.module.infra.framework.rpc.config.RpcConfiguration",
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/dillon-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/dillon-module-${table.moduleName}-server", "");
    ...
    private static String mapperXmlFilePath() {
        return "dillon-module-${table.moduleName}/" + // 顶级模块
                "dillon-module-${table.moduleName}-server/" + // 子模块
