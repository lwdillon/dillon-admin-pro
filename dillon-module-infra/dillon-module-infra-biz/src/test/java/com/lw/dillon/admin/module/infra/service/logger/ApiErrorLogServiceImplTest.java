...
import com.lw.dillon.admin.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.lw.dillon.admin.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.lw.dillon.admin.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.lw.dillon.admin.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.lw.dillon.admin.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.lw.dillon.admin.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.lw.dillon.admin.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("dillon-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("dillon-test");
