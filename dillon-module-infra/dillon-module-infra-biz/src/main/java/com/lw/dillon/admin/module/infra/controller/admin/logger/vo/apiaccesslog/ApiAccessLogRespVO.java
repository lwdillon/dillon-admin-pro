package com.lw.dillon.admin.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.lw.dillon.admin.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
