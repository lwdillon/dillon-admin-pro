package com.lw.dillon.admin.module.infra.service.codegen.inner;
...
import com.lw.dillon.admin.framework.apilog.core.enums.OperateTypeEnum;
import com.lw.dillon.admin.framework.common.exception.util.ServiceExceptionUtil;
...
import com.lw.dillon.admin.framework.common.util.date.LocalDateTimeUtils;
...
import com.lw.dillon.admin.framework.excel.core.annotations.DictFormat;
import com.lw.dillon.admin.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "dillon-module-${table.moduleName}/" + // 顶级模块
                "dillon-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "dillon-module-${table.moduleName}/" + // 顶级模块
                "dillon-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "dillon-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "dillon-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
