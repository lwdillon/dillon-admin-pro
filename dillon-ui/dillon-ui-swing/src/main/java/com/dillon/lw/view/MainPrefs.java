...
public class MainPrefs {
    ...
    public static final String THEME_UI_KEY = "__dillon_ui_siwng.theme";
    public static final String KEY_USER = "dillon_ui_siwng_user_";
    public static final String KEY_USER_CUR = "cur_dillon_ui_siwng_user";
