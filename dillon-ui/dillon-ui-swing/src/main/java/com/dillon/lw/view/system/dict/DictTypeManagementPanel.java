...
public class DictTypeManagementPanel extends JPanel {
    ...
    private JToolBar creatBar() {
        ...
        data.setForeground(UIManager.getColor("App.accent.color"));
    ...
    private void showAddDialog(Long id) {
        ...
        dialog.showDialogWithAsyncSubmit(
                formPane::validates,
                formPane::getValue,
                data -> Forest.client(DictTypeApi.class).createDictType(data).getCheckedData(),
                this::updateData,
                "添加成功！"
        );
    }
    ...
    private void showEditDialog() {
        ...
        dialog.showDialogWithAsyncSubmit(
                formPane::validates,
                formPane::getValue,
                data -> Forest.client(DictTypeApi.class).updateDictType(data).getCheckedData(),
                this::updateData,
                "修改成功！"
        );
    }
