...
//                countryPane.setFill(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#1F1F43") : Color.web("#ffffff"));
                worldMap.setFillColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#1F1F43") : Color.web("#ffffff"));
                worldMap.setTextColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#1F1F43") : Color.web("#ffffff"));
                worldMap.setStrokeColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#000000"));
            }
        });
    }
    ...
    public void init() {
        ...
        countryPane.setFill(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#000000"));
    ...
    public void initWoldMap() {
        worldMap = WorldBuilder.create()
                ...
                .fillColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#1F1F43") : Color.web("#ffffff"))
                .connectionWidth(2)
                ...
                .textColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#000000"))
                .strokeColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#000000"))
                .build();
