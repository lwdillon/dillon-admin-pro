...
//                .text("Some text")
                ...
                .barBackgroundColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"))
                .valueColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"))
                .unitColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"))
...
//                .text("Some text")
                .textColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"))
                .backgroundColor(Color.TRANSPARENT)
                .textVisible(false)
        ...
        MvvmFX.getNotificationCenter().subscribe("themeUpdate", (k,p) -> {
            if (ThemeManager.getInstance().getCurrentTheme() != null) {
                circularProgressTile.setBarBackgroundColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
                circularProgressTile.setValueColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
                circularProgressTile.setUnitColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));

                radialChartTile.setBarBackgroundColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
                radialChartTile.setTextColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));

                smoothAreaChartTile.setBarBackgroundColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
                smoothAreaChartTile.setTextColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
                smoothAreaChartTile.setUnitColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
                smoothAreaChartTile.setValueColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));

                smoothAreaChartTile2.setBarBackgroundColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
                smoothAreaChartTile2.setTextColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
                smoothAreaChartTile2.setUnitColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
                smoothAreaChartTile2.setValueColor(ThemeManager.getInstance().getCurrentTheme().isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
