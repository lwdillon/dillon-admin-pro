...
package com.lw.fx.view.control;
...
public class IconBrowser extends TableView<List<Ikon>> {
    ...
    private ObjectProperty<Ikon> value = new SimpleObjectProperty<>();
     ...
     class FontIconCell extends TableCell<List<Ikon>, Ikon> {
        ...
        public FontIconCell() {
            ...
            fontIcon.setOnMouseClicked(mouseEvent -> {
                value.set(fontIcon.getIconCode());
            });
        }
    ...
    public Ikon getValue() {
        return value.get();
    }

    public ObjectProperty<Ikon> valueProperty() {
        return value;
    }
}
