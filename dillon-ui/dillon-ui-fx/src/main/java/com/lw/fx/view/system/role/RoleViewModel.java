...
public class RoleViewModel implements ViewModel, SceneLifecycle {
    ...
    public void loadTableData() {
        ...
        ProcessChain.create()
                .addSupplierInExecutor(() -> Request.connector(RoleFeign.class).getRolePage(queryMap))
                .addConsumerInPlatformThread(listCommonResult -> {

                    if (listCommonResult.isSuccess()) {
                        ObservableList<RoleRespVO> userRespVOS = FXCollections.observableArrayList();
