...
import static com.lw.fx.AppUI.IS_DEV_MODE;
import static com.lw.fx.Resources.resolve;
import static com.lw.fx.theme.ThemeManager.*;
    ...
    public FileResource getResource() {
        ...
        try {
            FileResource testTheme = FileResource.createInternal(
                resolve("theme-test/" + filename), AppStart.class
            );
            if (!testTheme.exists()) {
