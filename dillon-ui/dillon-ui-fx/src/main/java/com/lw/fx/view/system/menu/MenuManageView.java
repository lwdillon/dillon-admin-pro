...
public class MenuManageView implements FxmlView<MenuManageViewModel>, Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        iconCol.setCellValueFactory(new TreeItemPropertyValueFactory<>("iconFont"));
                ...
                return new TreeTableCell<>() {
                    ...
                    protected void updateItem(String item, boolean empty) {
                        ...
                        if (StrUtil.equals("#", item)) {
                            ...
                            label.setGraphic(FontIcon.of(Feather.findByDescription(item)));
                        }
    ...
    private void showDelDialog(MenuRespVO sysMenu) {
       ...
       dialog.addActions(
                ...
                Map.entry(new Button("确定"), event -> {
                    ...
                    ProcessChain.create()
                            .addRunnableInExecutor(() -> viewModel.remove(sysMenu.getId()))
