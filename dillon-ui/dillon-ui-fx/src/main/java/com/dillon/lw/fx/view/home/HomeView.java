...
public class HomeView extends BaseView<HomeViewModel>{
    ...
    private Tab tab2;
    @FXML
    private SVGImageView imgView1;
    @FXML
    private SVGImageView imgView2;
    @FXML
    private SVGImageView imgView3;
    @FXML
    private SVGImageView imgView4;

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {


        imgView1.setSvgUrl(Resources.getResource("/images/aaa.svg").toString());
