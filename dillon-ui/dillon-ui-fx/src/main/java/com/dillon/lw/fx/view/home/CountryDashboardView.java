...
public class CountryDashboardView extends BaseView<CountryDashboardViewModel> {
    ...
    public void initWoldMap() {
        worldMap = WorldBuilder.create()
                ...
                .fillColor(AppStore.isDarkMode() ? Color.web("#1F1F43") : Color.web("#ffffff"))
                .connectionWidth(2)
                ...
                .textColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#000000"))
                .strokeColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#000000"))
                .build();
