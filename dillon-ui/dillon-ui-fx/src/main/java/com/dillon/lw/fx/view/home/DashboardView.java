...
public class DashboardView extends BaseView<DashboardViewModel> {
...
//                .text("Some text")
                ...
                .barBackgroundColor(AppStore.isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"))
                .valueColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"))
                .unitColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"))
...
//                .text("Some text")
                .textColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"))
                .backgroundColor(Color.TRANSPARENT)
                .textVisible(false)
        ...
        roectsTableView.setItems(viewModel.getRoects());
        activeProjectsTableView.setItems(viewModel.getActiveProjects());
...
//        timer.start();
    ...
    @Subscribe
    private void onTheme(ThemeEvent themeEvent) {
        Platform.runLater(() -> {
            circularProgressTile.setBarBackgroundColor(AppStore.isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
            circularProgressTile.setValueColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
            circularProgressTile.setUnitColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));

            radialChartTile.setBarBackgroundColor(AppStore.isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
            radialChartTile.setTextColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));

            smoothAreaChartTile.setBarBackgroundColor(AppStore.isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
            smoothAreaChartTile.setTextColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
            smoothAreaChartTile.setUnitColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
            smoothAreaChartTile.setValueColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));

            smoothAreaChartTile2.setBarBackgroundColor(AppStore.isDarkMode() ? Color.web("#334155") : Color.web("#afb8c1"));
            smoothAreaChartTile2.setTextColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
            smoothAreaChartTile2.setUnitColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
            smoothAreaChartTile2.setValueColor(AppStore.isDarkMode() ? Color.web("#ffffff") : Color.web("#475569"));
