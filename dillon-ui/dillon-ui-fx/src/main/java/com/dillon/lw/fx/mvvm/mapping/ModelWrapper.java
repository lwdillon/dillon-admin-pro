...
import com.dillon.lw.fx.mvvm.mapping.accessorfunctions.*;
...
public class ModelWrapper<M> {
     ...
     * </pre>
     *
     * @param getter a function that returns the current value of the field for a given model element. Typically you will
     ...
     * @param getter          a function that returns the current value of the field for a given model element. Typically you will
     *                        use a method reference to the getter method of the model element.
     * @param immutableSetter a function that returns a clone of this the given model element that has the given value set. Typically you will use a method
